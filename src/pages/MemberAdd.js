    ...
    <>
          ...
          <Row xs={1} md={3} className="home-second-width">
            ...
            >
              ...
              <div className="home-second-item">
                <img
                  src={require('../images/home/Home-2-1.png')}
                  alt="Background"
                />
              </div>
            ...
            >
              ...
              <div className="home-second-item">
                <img
                  src={require('../images/home/Home-2-3.png')}
                  alt="Background"
                />
              </div>
              <div className="home-second-item-text">
      ...
      <div className="bg-pink view-height">
        ...
        <Row className="home-third-width">
          ...
          <Col xs={12} md={3}>
            <div
              className="context-side home-context-side"
              data-aos="fade-in"
              data-aos-duration="800"
            >
    ...
    <>
      <Modal show={show} id="register-modal">
        ...
        <Modal.Body>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    {emailMessage ? (
                      <div className="Register-feedback">{emailMessage}</div>
                    ) : (
                      ''
                    )}
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    {pwMessage ? (
                      <div className="Register-feedback">{pwMessage}</div>
                    ) : (
                      ''
                    )}
                  </td>
          ...
          <button
            className="btn-green Register-cancel"
            onClick={() => {
              props.history.push('/Home');
            }}
          >
